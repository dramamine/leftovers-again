...
The `team()` takes team data in other formats - see the [code documentation](http://metal-heart.org/leftovers-again/docs/class/src/lib/team.js~Team.html) for more details.

Note that if you're playing the `randombattle` format, you don't need to define `team()`.

### What's in a request?
The heart of developing a bot lies in processing the `state` data from each turn / request, and choosing your moves & switches wisely. Check the [code documentation](http://metal-heart.org/leftovers-again/docs/class/src/ai.js~AI.html) for more details.
...
[code documentation](http://metal-heart.org/leftovers-again/docs/class/src/ai.js~AI.html#instance-method-decide)

Besides the docs for `state`, you'll also wnat to familiarize yourself with what's in a [Pokemon object](http://metal-heart.org/leftovers-again/docs/typedef/index.html#static-typedef-PokemonData) and what's in a [Move object](http://metal-heart.org/leftovers-again/docs/typedef/index.html#static-typedef-MoveData)
