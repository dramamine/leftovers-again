...
var Damage = function () {
  ...
  _createClass(Damage, [{
    ...
    key: '_maximizeStat',
    value: function _maximizeStat(mon, stat) {
    ...
    key: '_minimizeStat',
    value: function _minimizeStat(mon, stat) {
    ...
    key: '_assumeStat',
    value: function _assumeStat(mon, stat) {
      var evs = arguments.length <= 2 || arguments[2] === undefined ? 85 : arguments[2];
      var natureMultiplier = arguments.length <= 3 || arguments[3] === undefined ? 1 : arguments[3];
    ...
    key: '_calculateStat',
    value: function _calculateStat(mon, stat) {
      var evs = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
      var natureMultiplier = arguments.length <= 3 || arguments[3] === undefined ? 1 : arguments[3];
      ...
      var nature = mon.nature ? this._getNatureMultiplier(mon.nature, stat) : natureMultiplier;
    ...
    key: '_getNatureMultiplier',
    value: function _getNatureMultiplier(nature, stat) {
      if (!nature) return 1;
      if (!NATURES[nature]) {
    ...
    value: function assumeStats(mon) {
      ...
      [AT, SA, DF, SD, SP, HP].forEach(function (stat) {
        if (!mon.stats[stat]) {
          mon.stats[stat] = _this2._calculateStat(mon, stat, 85, 1);
        }
      });
    ...
    value: function getDamageResult(a, d, move) {
      ...
      var maxOnly = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];
