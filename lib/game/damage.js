...
class Damage {
  ...
  _calculateStat(mon, stat, evs = 0, natureMultiplier = 1) {
    ...
    const calculated = (mon.baseStats[stat] * 2 + 31 + evBonus) * (mon.level / 100) + addThis;

    const nature = mon.nature ? this._getNatureMultiplier(mon.nature, stat) : natureMultiplier;
