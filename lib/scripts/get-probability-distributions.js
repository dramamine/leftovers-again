...
function natureVariance(data) {
  ...
  const PROBABILITY_AND_CHANGE = [[4 / 25 * (4 / 25), 10 / 11 * (10 / 11)], [2 * (4 / 25) * (17 / 25), 10 / 11], [17 / 25 * (17 / 25) + 2 * (4 / 25) * (4 / 25), 1], [2 * (4 / 25) * (17 / 25), 11 / 10], [4 / 25 * (4 / 25), 11 / 10 * (11 / 10)]];
