...
_inquirer2.default.prompt(questions).then(answers => {
  ...
  _fs2.default.mkdirSync(_path2.default.join(process.cwd(), 'log'));
  _fs2.default.mkdirSync(_path2.default.join(process.cwd(), 'src'));
  ...
  filez.forEach(file => {
    ...
    parseAndWrite(_path2.default.join(tmpltDir, lang, file), _path2.default.join(process.cwd(), file), answers);
  });
