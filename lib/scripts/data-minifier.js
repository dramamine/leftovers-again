...
var _moves = require('../deps/Pokemon-Showdown/data/moves');

var _movedata = require('../deps/honko-damagecalc/js/data/movedata');

var _movedata2 = _interopRequireDefault(_movedata);

var _pokedex = require('../deps/Pokemon-Showdown/data/pokedex');

var _formatsData = require('../deps/Pokemon-Showdown/data/formats-data');
